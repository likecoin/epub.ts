...
- **1206 tests passing** across 46 test files
...
|--------|------|------|----------|
| ESM | `dist/epub.js` | ~272 KB | Modern bundlers (Vite, webpack, Rollup) |
| CJS | `dist/epub.cjs` | ~175 KB | `require()` in legacy Node.js setups |
| UMD | `dist/epub.umd.js` | ~175 KB | `<script>` tags / CDN |
| Node ESM | `dist/epub.node.js` | ~263 KB | `@likecoin/epub-ts/node` |
| Node CJS | `dist/epub.node.cjs` | ~167 KB | `require("@likecoin/epub-ts/node")` |
